<x-app-layout>
    <div class="task-container single-task py-10">
        <div class="task-header">
            <h1 class="text-3xl py-4" style='color:grey'>Created at: {{ $note->created_at }}</h1>
            <h1 class="text-3xl py-4" style='color:grey'>Start: {{ $note->Start }}</h1>
            <h1 class="text-3xl py-4" style='color:grey'>Due: {{ $note->Due }}</h1>
